...
public class UserDao {
    ...
    public User addUser(String email, String name, String password){
        //Service에서 이미 트랜잭션이 시작했기 때문에, 그 트랜잭션에 포함됨.
        User user = new User();
        user.setEmail(email);
        user.setName(name);
        ...
        Number number = insertUser.execute(params);
    ...
    public List<String> getRoles(int userId) {
        String sql = "select r.name from user_role ur, role r where ur.role_id = r.role_id and user_id =:userId";
